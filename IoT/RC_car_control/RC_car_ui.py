...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(10, 10, 191, 171))
        self.lb_handle_left = QLabel(self.groupBox)
        self.lb_handle_left.setObjectName(u"lb_handle_left")
        self.lb_handle_left.setGeometry(QRect(10, 30, 61, 16))
        self.le_handle_left = QLineEdit(self.groupBox)
        self.le_handle_left.setObjectName(u"le_handle_left")
        self.le_handle_left.setGeometry(QRect(80, 30, 81, 21))
        self.le_handle_center = QLineEdit(self.groupBox)
        self.le_handle_center.setObjectName(u"le_handle_center")
        self.le_handle_center.setGeometry(QRect(80, 60, 81, 21))
        self.lb_handle_center = QLabel(self.groupBox)
        self.lb_handle_center.setObjectName(u"lb_handle_center")
        self.lb_handle_center.setGeometry(QRect(10, 60, 61, 16))
        self.le_handle_right = QLineEdit(self.groupBox)
        self.le_handle_right.setObjectName(u"le_handle_right")
        self.le_handle_right.setGeometry(QRect(80, 90, 81, 21))
        self.lb_handle_right = QLabel(self.groupBox)
        self.lb_handle_right.setObjectName(u"lb_handle_right")
        self.lb_handle_right.setGeometry(QRect(10, 90, 61, 16))
        self.btn_handle_save = QPushButton(self.groupBox)
        self.btn_handle_save.setObjectName(u"btn_handle_save")
        self.btn_handle_save.setGeometry(QRect(10, 120, 151, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Handle", None))
